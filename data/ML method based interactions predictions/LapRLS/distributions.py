...
def main():
    ...
    CRD = "CRD_LapRLS_predictions.csv"
    WP4 = "wp4_drugs_drugs_interactions_LapRLS_predictions.csv"
    UMLS = "drug-side-effect_LapRLS_UMLS_predictions.csv"
    HPOSim = "drug-side-effect_LapRLS_HPOSim_predictions.csv"
    enzyme = "drug_enzyme_LapRLS_predictions.csv"
    target = "drug_target_LapRLS_predictions.csv"
    ...
    plt.title("Drug interactions using LapRLS")
    plt.show()
