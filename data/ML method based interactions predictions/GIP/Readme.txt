...
the machine learning method GIP [1] for several datasets.
...
* DDI_GIP_predictions.csv : Predictions between drug-drug interactions.
...
* NCRD_GIP_predictions.csv : Predictions between NCRD drug-drug interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* CRD_GIP_predictions.csv : Predictions between CRD drug-drug interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* wp4_drugs_drugs_interactions_GIP_predictions.csv : Predictions between drug-drug interactions generated by WP4.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* drug-side-effect_GIP_UMLS_predictions.csv : Predictions between drug side-effects interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
...
* drug-side-effect_GIP_HPOSim_predictions.csv : Predictions between drug side-effects interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ .
...
* drug_enzyme_GIP_predictions.csv : Predictions between drug-enzyme interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ .
...
* drug_target_GIP_predictions.csv : Predictions between drug-target interactions.
