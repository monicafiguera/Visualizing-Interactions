...
def main():
    DDI = "DDI_GIP_predictions.csv"
    NCRD = "NCRD_GIP_predictions.csv"
    CRD = "CRD_GIP_predictions.csv"
    WP4 = "wp4_drugs_drugs_interactions_GIP_predictions.csv"
    UMLS = "drug-side-effect_GIP_UMLS_predictions.csv"
    HPOSim = "drug-side-effect_GIP_HPOSim_predictions.csv"
    enzyme = "drug_enzyme_GIP_predictions.csv"
    target = "drug_target_GIP_predictions.csv"
    ...
    plt.title("Drug interactions using GIP")
    plt.show()
