...
the machine learning method KBMF2K [1] for several datasets.
...
* DDI_KBMF2K_predictions.csv : Predictions between drug-drug interactions.
...
* NCRD_KBMF2K_predictions.csv : Predictions between NCRD drug-drug interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* CRD_KBMF2K_predictions.csv : Predictions between CRD drug-drug interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* wp4_drugs_drugs_interactions_KBMF2K_predictions.csv : Predictions between drug-drug interactions generated by WP4.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ and also see
http://www.rdkit.org/docs/GettingStartedInPython.html#fingerprinting-and-molecular-similarity .

* drug-side-effect_KBMF2K_UMLS_predictions.csv : Predictions between drug side-effects interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
...
* drug-side-effect_KBMF2K_HPOSim_predictions.csv : Predictions between drug side-effects interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ .
...
* drug_enzyme_KBMF2K_predictions.csv : Predictions between drug-enzyme interactions.
The similarity measure used to compare the drugs was Tanimoto similarity measure of RDKit.
The version of RDKit used is available at https://www.rdkit.org/ .
...
* drug_target_KBMF2K_predictions.csv : Predictions between drug-target interactions.
