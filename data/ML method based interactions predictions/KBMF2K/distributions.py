...
def main():
    DDI = "DDI_KBMF2K_predictions.csv"
    NCRD = "NCRD_KBMF2K_predictions.csv"
    CRD = "CRD_KBMF2K_predictions.csv"
    #WP4 = "wp4_drugs_drugs_interactions_KBMF2K_predictions.csv"
    UMLS = "drug-side-effect_KBMF2K_UMLS_predictions.csv"
    HPOSim = "drug-side-effect_KBMF2K_HPOSim_predictions.csv"
    enzyme = "drug_enzyme_KBMF2K_predictions.csv"
    target = "drug_target_KBMF2K_predictions.csv"
    ...
    dataFrames = [df1, df2, df3, df5, df6, df7, df8]
    dataFramesNames = ["DDI", 
                       "NCRD", 
                       "CRD", 
                       #"WP4", 
    ...
    plt.title("Drug interactions using KBMF2K")
    plt.show()
